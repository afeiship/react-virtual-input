  ...
  render(){
    return (
      <div className="hello-react-virtual-input">
          ...
          <ReactVirtualInput focused={true} clearable={true} onClear={this._clear} placeholder="input your text.." filter={this._toPwd.bind(this)} maxLength={100} value={this.state.value} />
      </div>
    );
  }
}
